...
//                                                            $(".selectedModalLi").show();
                                                            ...
                                                            var html = '';
                                                            var html2 = '';
                                                            html = '<li class="media allissue singleIssue_'+issueId+'"><img class="d-flex" src="'+issueImg+'" alt="" /><div class="media-body">'+issueName+'<span class="price">£ '+issuePrice+' <a href="javascript:void(0);" onclick=javascript:removeissue('+issueId+','+issuePrice+'); class="pull-right"><img class="m-0" src="'+site_url+'lib/frontend/img/cross.png" alt="" /></a></span></div></li>';  
