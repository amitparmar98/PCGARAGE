...
{ 
 ...
 setInterval(function() {
    ...
    var url = $('.url').val();
       ...
       $.ajax({
        url: url + "repair/otherChat1/" + orderId +'/'+lastId,
        type: "get",
        async : false,
      ...
      /*$('#other_chat_form').submit(function (event) {*/
        ...
        var posting = $.post(url+'/repair/saveOtherChat', $("#other_chat_form").serialize());
        ...
        var data = $.parseJSON(result);
              ...
              var html = '';
              html+= '<li class="self">';
              html+= '<div class="avatar"><img src="'+user_image_url+'" draggable="false" alt="user"/></div>';
              html+='<div class="msg">';
   ...
   /* function saveOtherChat()
    {
        $("#other_chat_form").submit();
    }*/
