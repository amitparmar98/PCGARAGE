		...
		<aside class="main-sidebar">
			<section class="sidebar">
				<ul class="sidebar-menu">
					...
					<li class="treeview <?php if(isset($title) && $title == 'SELL ORDERS') { echo 'active'; } ?>">
						<a href="#">
						<i class="fa fa-dashboard"></i> <span>SELL ORDERS</span> <i class="fa fa-angle-left pull-right"></i>
						</a>
						<ul class="treeview-menu">
							<li class="<?php if(isset($title) && $title == 'SELL ORDERS') { echo 'active'; } ?>"><a href="<?php echo base_url('admin/order/sellOrder');?>"><i class="fa fa-edit"></i></i> ALL ORDERS</a></li>
						</ul>
					</li>
