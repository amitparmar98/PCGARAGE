					...
					<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/admin/order/saveVendor/<?php echo $v->id; ?>" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="fullname">Order No</label>
								<div class="col-sm-10">
                                                                    <input type="text" name="id" readonly placeholder="NAME" value="<?php echo 'PCG'.$rowi[0]->id; ?>" id="fullname" class="form-control" required>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="status" class="form-control">
										<option value="0">Select Status</option>
											...
											<option <?= 'pending' == $v->status?'selected="selected"':'';?> value="pending">Pending</option>
											<option <?= 'process' == $v->status?'selected="selected"':'';?> value="process">Process</option>
											<option <?= 'complete' == $v->status?'selected="selected"':'';?> value="complete">Complete</option>
