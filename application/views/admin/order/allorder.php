	...
	<section class="content">
		<div class="row">
			<div class="col-xs-12 col-sm-12">
				<div class="box">
					<div class="box-body">
						<label for="email">ORDER LIST:</label>
					</div>
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo date("d M,Y h:i:a", strtotime($order->datetime)); ?></td>
									...
									<?php
										$query = $this->db->query("SELECT * FROM services WHERE id = '".$order->service."'");
										$row = $query->result();
										//echo "<pre>"; print_r($row);
									?>
